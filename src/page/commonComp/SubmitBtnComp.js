...
export const AuditBtn = (props) => {
    return (
        <div className={`submitBox ${props.isBtnHide ? "hide" : "show"}`}>
            ...
            />
            <input type="text" name="faceSg" className={props.status === '3' ? "hide" : "submitBtnFS"}
                value="面签" readOnly={true}
                onClick={props.handleClickAudit}
            />
            ...
            <input type="text" name="reject" className={props.status === '3' ? "hide" : "submitBtnRJ"}
                ...
                onClick={props.handleClickAudit}
            />
            <input type="text" name="unLock" className={props.status === '3' ? "submitBtnUL" : "hide"}
                value="解锁" readOnly={true}
                onClick={props.handleClickAudit}
            />
            <style>{`
                .submitBox{
