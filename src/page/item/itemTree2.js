            ...
            <div className="wrapper">
                <div className="wrapper-detail colorAddBG">
                    ...
                    <div className="content_mainS">
                        ...
                        <div className="spaceG" />
                        <div className="content_mainDetail">
                            <DetailBold label="结转下发" value={getMoneyNumber(this.data.res.money1)} />
                            <DetailBold label="年初下发" value={getMoneyNumber(this.data.res.money11)} />
                            <DetailBold label="调整下发" value={getMoneyNumber(this.data.res.money111)} />
                            <DetailBold label="下发合计" value={getMoneyNumber(this.data.res.sum1)} />
                        </div>
                        <div className="spaceG" />
                        <div className="content_mainDetail">
                            <DetailBold label="结转分配" value={getMoneyNumber(this.data.res.money2)} />
                            <DetailBold label="年初分配" value={getMoneyNumber(this.data.res.money22)} />
                            <DetailBold label="调整分配" value={getMoneyNumber(this.data.res.money222)} />
                            <DetailBold label="合计" value={getMoneyNumber(this.data.res.sum2)} />
                        </div>
                        <div className="spaceG" />
                        <div className="content_mainDetail">
                            <DetailBold label="结转余额" value={getMoneyNumber(this.data.res.money3)} />
                            <DetailBold label="年初余额" value={getMoneyNumber(this.data.res.money33)} />
                            <DetailBold label="调整余额" value={getMoneyNumber(this.data.res.money333)} />
                            <DetailBold label="待分配余额合计" value={getMoneyNumber(this.data.res.sum3)} />
                        </div>
                        <div className="spaceG" />
                    </div>
                </div>
